...
#
#Script Description: The functions listed below were developed to analysed the data used in: "Addressing gaps in small-scale fisheries: a low-cost tracking system"
#
#
#Notes:
#
